...
export class TrainingCreatePage implements OnInit {
  ...
  createTraining(): void {
    ...
    this.trainingService
      .createTraining(this.training.title, this.training.description, this.training.location, this.training.timeFrom, this.training.timeTo, this.training.weekday, this.training.startDate, this.training.repeat, this.training.clubId, this.training.teamId )
      .then(() => {
