...
export class TeamPage implements OnInit {
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'Hinzufügen',
          handler: (member) => {
            this.teamService.addAdminToTeam(this.teamId, member.id).then(
              (ok) => {
                console.log(ok);
                this.toastController
                  .create({
  ...
  removeAdminFromTeam(userId) {
    this.teamService.removeAdminFromTeam(this.teamId, userId).then(
      (ok) => {
        this.toastController
          .create({
  ...
  removeMemberFromTeam(userId) {
    this.teamService.removeMemberFromTeam(this.teamId, userId).then(
      (ok) => {
        console.log(ok);
        this.toastController
          .create({
  ...
  saveTeam() {
    this.teamService.saveTeam(this.team).then(
      (done) => {
        this.toastController
          .create({
