...
import {Plugins, GeolocationPosition, Browser} from '@capacitor/core';
    ...
    Geolocation.requestPermissions().then(
      async (ok) => {
        ...
        markers.push({
          ...
          infoWindowOptions: {
            content:
              '<div class="mygooglemaps" id="content maps">' +
              '<div id="siteNotice">' +
              '</div>' +
              '<h1 id="firstHeading" class="firstHeading">' +
              this.game.sportshall +
              '</h1>' +
              '<div id="bodyContent">' +
              '<p>' +
              this.game.sportshall +
              ...
              this.game.location +
              '</p>' +
              '<p><a target="_blank" href="https://www.google.com/maps/dir/' +
