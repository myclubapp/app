...
export class ClubPage implements OnInit {
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'Hinzufügen',
          handler: (member) => {
            this.teamService.addAdminToClub(this.clubId, member.id).then(
              (ok) => {
                console.log(ok);
                this.toastController
                  .create({
  ...
  removeAdminFromClub(userId) {
    this.teamService.removeAdminFromClub(this.clubId, userId).then(
      (ok) => {
        this.toastController
          .create({
  ...
  removeMemberFromClub(userId) {
    this.teamService.removeMemberFromClub(this.clubId, userId).then(
      (ok) => {
        this.toastController
          .create({
  ...
  saveClub() {
    this.teamService.saveClub(this.club).then(
      (done) => {
        this.toastController
          .create({
