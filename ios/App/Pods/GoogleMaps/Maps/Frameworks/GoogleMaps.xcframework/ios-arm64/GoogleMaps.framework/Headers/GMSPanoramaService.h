...
/**
 * Similar to `-requestPanoramaNearCoordinate:callback:` but allows specifying a search radius
...
/**
 * Similar to `-requestPanoramaNearCoordinate:callback:` but allows specifying the panorama source
